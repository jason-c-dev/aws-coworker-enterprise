...
# Server directory (where server code lives)
SERVER_DIR = Path(__file__).parent.resolve()

# Session workspace base — lives inside server/ by default,
# override via WORKSPACE_BASE_PATH for production (e.g., EBS volume, S3-backed path)
WORKSPACE_BASE = Path(os.getenv(
    "WORKSPACE_BASE_PATH",
    SERVER_DIR / "workspaces"
))
