...
| D-G3 | ⬜ | 2026-02-16 | FAIL 1: CloudWatch logging (Medium) marked ACCEPTABLE at strict enforcement. Root cause: plan-interaction.md said "Critical/High BLOCKED; Medium/Low ACCEPTABLE". FIX 1: Updated strict tier to block Critical/High/Medium. FAIL 2 (retest): Agent initially BLOCKED CloudWatch correctly, then self-contradicted mid-evaluation by re-reading old rules from SKILL.md and environments.yaml which still said "Critical/High blocked". Root cause: fix only applied to plan-interaction.md, not SKILL.md or environments.yaml. FIX 2: Updated all three files to consistent "Critical/High/Medium blocked" at strict. RETEST PENDING |
| D-G4 | ⬜ | | |
| D-D1 | ⬜ | | |
| D-D2 | ⬜ | | |
| D-D3 | ⬜ | | |
